...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _handleSignup() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Save the user's information to UserService
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Subtitle
              Text(
                'Join Fylez and secure your files with blockchain technology',
                style: TextStyle(
                  fontSize: 16,
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          icon: HeroIcon(
                            _isPasswordVisible ? HeroIcons.eyeSlash : HeroIcons.eye,
                          ),
                          onPressed: () {
                            setState(() {
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          icon: HeroIcon(
                            _isConfirmPasswordVisible ? HeroIcons.eyeSlash : HeroIcons.eye,
                          ),
                          onPressed: () {
                            setState(() {
